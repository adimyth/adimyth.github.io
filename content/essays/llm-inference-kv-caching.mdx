...
I produced every figure in this essay with the three scripts below, and you can rerun them.
...
All three are short enough to read before running. They make the cache’s memory cost and the avoided recomputation checkable in about a minute rather than taken on trust.
