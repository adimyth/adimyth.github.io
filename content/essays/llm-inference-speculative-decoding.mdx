...
[Leviathan et al.](https://arxiv.org/abs/2211.17192) put a number on it. Write `a` for the acceptance rate: the chance that any single guess is the one the target would have written. Expected output tokens per round is then
