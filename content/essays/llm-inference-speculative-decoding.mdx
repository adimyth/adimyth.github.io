...
Everything below runs on an M4 Pro: **Qwen2.5-7B-Instruct** as the target, **Qwen2.5-0.5B-Instruct** as the draft, fp16 on MPS, greedy, medians of three runs. The code is in [adimyth/llm-inference-experiments](https://github.com/adimyth/llm-inference-experiments).
...
Every number above comes from [adimyth/llm-inference-experiments](https://github.com/adimyth/llm-inference-experiments).
