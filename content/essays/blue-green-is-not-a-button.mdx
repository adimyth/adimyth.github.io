...
The runbook, parameter tables and helper scripts are on GitHub at [adimyth/rds-postgres-blue-green-upgrade](https://github.com/adimyth/rds-postgres-blue-green-upgrade). Take what is useful, and read the limitations page first.
