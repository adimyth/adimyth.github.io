...
import { getEssayPage, formatEssayDate } from "@/lib/essays";
import { profile } from "@/lib/data";
import EssayPagination from "@/components/EssayPagination";

export const metadata = {
  title: `Essays — ${profile.name}`,
  description: "Long-form writing on AI engineering, systems thinking, and building at scale.",
};

export default function EssaysIndex() {
  const { essays, totalPages } = getEssayPage(1);
  ...
  return (
    <main className="min-h-screen bg-[#f4f1ea] px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <EssayPagination currentPage={1} totalPages={totalPages} />
      </div>
    </main>
  );
}
