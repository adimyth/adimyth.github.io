  ...
  return (
    <section id="essays" className="py-8 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div>
          {essays.map((essay) => (
            <Link
              ...
              className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-6 py-4 border-b border-line first:border-t hover:border-line-hover transition-colors"
            >
              <p className="text-base font-medium text-ink leading-snug min-w-0">
                {essay.title}
                {essay.draft && (
              ...
              <p className="shrink-0 text-sm font-medium text-quiet">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-ink hover:text-ink-soft transition-colors"
        >
          All essays
