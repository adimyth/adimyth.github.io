...
## Send a selected passage to Claude Code

The essay page includes a development-only Claude handoff. Select a passage, choose an intent, add an optional note, then send it directly to a Claude Code session running in tmux.
